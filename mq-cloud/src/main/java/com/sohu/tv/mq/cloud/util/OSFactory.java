...
import com.sohu.tv.mq.cloud.task.server.data.OSInfo.DistributionType;
import com.sohu.tv.mq.cloud.task.server.data.OSInfo.DistributionVersion;
import com.sohu.tv.mq.cloud.task.server.data.OSInfo.OSType;
import com.sohu.tv.mq.cloud.task.server.data.OSInfo.ProcessorArchitecture;
