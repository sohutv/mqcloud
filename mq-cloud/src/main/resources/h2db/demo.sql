...
INSERT IGNORE INTO `common_config` VALUES ('19',  'adminAccessKey', 'mqcloud', '管理员访问名(broker&nameserver使用)');
INSERT IGNORE INTO `common_config` VALUES ('20',  'adminSecretKey', '54ADMIN', '管理员访问私钥(broker&nameserver使用)');
...
-- server init
-- ----------------------------
insert IGNORE into server(ip,dist,machine_type,room) values ('127.0.0.1', 'init' , 3, '默认');

-- ----------------------------
-- cluster init
-- ----------------------------
insert IGNORE into cluster(id, name, vip_channel_enabled, online, transaction_enabled, trace_enabled) values (1, 'test-cluster', 1, 0, 0, 0);
-- ----------------------------
-- ns init
-- ----------------------------
insert IGNORE into name_server(cid,addr,base_dir) values(1,'127.0.0.1:9876','/opt/mqcloud/ns');
-- ----------------------------
-- broker init
-- ----------------------------
insert IGNORE into broker(cid,addr,broker_name,broker_id,base_dir) values(1,'127.0.0.1:10911','broker-a',0,'/opt/mqcloud/broker-a');