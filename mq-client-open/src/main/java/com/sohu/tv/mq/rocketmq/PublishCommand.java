...
/**
 * Producer Publish 隔离封装
 * 
 * @Description: 提供rocketmq Publish方式，隔离发送
 * @author yongfeigao
 * @date 2018年1月24日
 */
@Deprecated
public class PublishCommand extends AbstractCommand<Result<SendResult>> {
    ...
    public static final String COMMAND_KEY = "Publish";
    ...
    public PublishCommand(RocketMQProducer producer, Object messageObject) {
        this(producer, messageObject, null);
    }

    public PublishCommand(RocketMQProducer producer, Object messageObject, String keys) {
        this(producer, messageObject, keys, POOLSIZE, producer.getProducer().getSendMsgTimeout());
    }

    public PublishCommand(RocketMQProducer producer, Object messageObject, String keys, int poolSize, int timeout) {
        this(producer, messageObject, keys, GROUP_KEY, COMMAND_KEY, poolSize, timeout, DefaultAlerter.getInstance());
    }

    public PublishCommand(RocketMQProducer producer, Object messageObject, String keys, String groupKey,
    ...
    protected Result<SendResult> invoke() throws Exception {
        return producer.publishWithException(messageObject, keys);
    }
